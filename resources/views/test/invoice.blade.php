...
<body>
    ...
    <div class="bootdey container-fluid">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div>
                                        <ul class="list-unstyled spaced">
                                            <li>
                                                <p>GF02 - Business Center, 57 - 59 Ho Tung Mau St.
                                                </p>
                                            </li>
                                            ...
                                            <li>
                                                ...
                                                Phone:
                                                <b class="red">0858458469</b>
                                            </li>
                                            <li>
                                                <i class="ace-icon fa fa-caret-right blue"></i>
                                                Email:
                                                <b class="red">davigithub16@gmail.com</b>
                                            </li>
                                            <li class="divider"></li>
                                    ...
                                    <div>
                                        <ul class="list-unstyled spaced">
                                            ...
                                            <li>
                                                <i class="ace-icon fa fa-caret-right blue"></i>
                                                Phone:
                                                <b class="red">{{ $ordered->phone }}</b>
                                            </li>
                                            <li>
                                                <i class="ace-icon fa fa-caret-right blue"></i>
                                                Email:
                                                <b class="red">{{ $ordered->email }}</b>
                                            </li>
                                        </ul>
                                    </div>
                                </div><!-- /.col -->
