...
<body>
    <div class="card reg">
        <form method="POST" action="{{ route('register') }}">
            ...
            <p class="subtitle">Bạn đã có tài khoản? <a href="{{ route('login') }}">Đăng Nhập</a></p>
            <p class="subtitle">Quay về Trang Chủ? <a href="{{ route('home') }}">Trang Chủ</a></p>
            ...
            <div class="email-login">
                <div class="form-group">
                    ...
                    <input type="text" placeholder="Nhập Họ và Tên" name="name" value="{{ old('name') }}" required>
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <input type="text" placeholder="Nhập Số điện thoại" name="phone" value="{{ old('phone') }}" required>
                    @error('phone')
                    <span class="invalid-feedback">
                        <strong>{{ $message }}</strong>
                    </span>
