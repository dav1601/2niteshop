<div class="col-3 prd__s--item mb-4">
    <div class="card">
        ...
        <div class="prd-info p-3">
            ...
            <span class="price d-block"><i class="fas fa-tags pr-1"></i>Giá bán: {{ crf($prd->price) }}</span>
            <span class="price__cost price d-block" style="color:#dd991b;"><i class="fas fa-tags pr-1"></i>Giá gốc:
                {{ crf($prd->historical_cost) }}</span>
            <span class="prdcer d-block"><i class="fas fa-building pr-1"></i>Producer: {{ $prd->producer->name }}</span>
            <span class="model d-block"><i class="fab fa-unity pr-1"></i>Model: {{ $prd->model }}</span>
            <span class="usage d-block"><i class="fas fa-box-open pr-1"></i> {{ usage_stt($prd->usage_stt) }}</span>
            ...
            <div class="form-group mt-2">
                <select class="custom-select" name="" id="product__show--stock" data-id="{{ $prd->id }}">
                    <option value="{{ $prd->stock }}">{{ stock_stt($prd->stock) }}</option>
