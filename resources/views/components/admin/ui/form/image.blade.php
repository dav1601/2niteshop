@props(['id' => '', 'image' => '', 'note' => '', 'name' => '', 'width' => 'auto', 'height' => 'auto', 'label' => 'Upload Image', 'required' => false, 'classImage' => '', 'blockEventDef' => 'false', 'classUpload' => '', 'classClear' => '', 'classInput' => ''])
@php
    $isEdit = $image ? true : false;
    $note = $note ? $note : 'Hình ảnh size không vượt quá 1mb , Các đuôi cho phép: jpeg,png,jpg,tiff,svg';
    $image = $isEdit ? $image : 'https://res.cloudinary.com/vanh-tech/image/upload/v1684567283/logo/blank-image_tgsc4d.svg';
@endphp
<div class="w-100 a-ui-file-upload-wp">
    ...
    @endisset
            ...
            accept="image/png, image/jpeg, image/svg, image/tiff, image/jpg "
