        ...
        <nav class="nav" id="nav-menu">
            <div class="nav__content bd-grid">
                ...
                <div class="nav__perfil">
                    <div class="nav__img">
                        <img src="{{ $daviUser->getAvatarUser(Auth::id()) }}" alt="" height="100%" width="100%">
                    </div>
                    <div>
                    <a href="{{ route('admin_profile' ,['id'=>Auth::id()]) }}" target="_blank" class="nav__name">{{ Auth::user()->name }}</a>
                ...
                <div class="nav__menu">
                    <ul class="nav__list">
                        <li class="nav__item"><a href="{{ route('home') }}" target="_blank"  class="nav__link active">Trang chủ</a></li>
