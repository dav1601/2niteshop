...
<div class="d-flex item-activiti justify-content-start align-items-center">
    <img src="{{ $file->ver_img($item->main_img) }}" class=" rounded-circle " width="50" height="50"
        alt="">
    <div class="content flex-grow-1 d-flex justify-content-between align-items-center">
        <div class="activivi">
            <span class="d-block title"><strong>Bạn</strong> đã đăng sản phẩm <a
                    target="_blank"
                    href="{{ route('detail_product' ,['slug' => $item->slug]) }}">{{
                    $item->name }}</a> </span>
            <span class="d-block time">
                ...
                @elseif (!$carbon -> create($item->created_at) -> isToday() && !$carbon ->
        ...
        <div class="view_time">
            <span class="d-block time-ago mb-1"> {{ $carbon ->
...
@else
<div class="d-flex item-activiti justify-content-start align-items-center">
    <img src="{{ $file->ver_img($item->img) }}" class=" rounded-circle " width="50" height="50"
        alt="">
    <div class="content flex-grow-1 d-flex justify-content-between align-items-center">
        <div class="activivi">
            @php
