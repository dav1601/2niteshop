...
@endphp
<nav aria-label="Page navigation example" class="{{ $mt }}">
    <ul class="pagination {{ $position . '  ' . $size }}" id="{{ $id }}">
        @if ($page > 1)
            <li class="page-item {{ $class }}"><a class="page-link" data-page="1">
        ...
        @if ($page < $number_page - $point)
            <li class="page-item"><a class="page-link">...</a></li>
            <li class="page-item {{ $class }}"><a class="page-link" data-page="1"> {{ $number_page }} </a>
            </li>
        @endif
        @if ($page < $number_page)
