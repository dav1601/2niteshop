            ...
            <div class="home__right--slide">
                <div id="homeSlide" class="carousel slide w-100" data-ride="carousel">
                    <ol class="carousel-indicators">
                        @for ($i = 0 ; $i < count($slides) ; $i++) @if ($i==0) <li data-target="#homeSlide"
        ...
        <div class="show__home--box box__{{ $cf->id }} mb-5">
            ...
            <div class="box__cat">
                ...
                <div class="box__cat--item">
                    ...
                    <ul class="nav cat__tab" id="myTab__{{ $cf->id }}" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="active active-{{$cf->cat }}" data-toggle="tab" href="#tab__mh--{{ $cf->id }}"
                                role="tab" aria-controls="home" aria-selected="true">Máy {{
                                App\Models\Category::where('id', '=' , $cf->cat)->first() -> name }}</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="  active-{{$cf->cat }}" data-toggle="tab" href="#tab__aces--{{ $cf->id }}"
                    ...
                    <div class="tab-content" id="myTabContent__{{ $cf->id }}">
                        ...
                        <div class="tab-pane" id="tab__aces--{{ $cf->id }}" role="tabpanel">
                            ...
                            <div class="owl-carousel owl-theme">
                                ...
                                <div class="item">
                                    <x-product.itemgrid type="1" class="prdhome" :message="$aces" />
                                </div>
                                @endforeach
                            </div>
                            @else
                    ...
                    <div class="owl-carousel owl-theme">
                        ...
                        @endphp
                        <div class="item">
                            <x-product.itemgrid type="1" class="prdhome" :message="$prd" />
                        </div>
                        @endforeach
                        @endif
                        {{-- end option --}}
                ...
                <div class="box__cat--item --item-2 mt-5">
                    ...
                    <ul class="nav cat__tab" id="myTab__{{ $cf->cat_2  }}" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="  active-{{$cf->cat_2 }}" data-toggle="tab" href="#tab__aces--{{ $cf->cat_2 }}"
                                role="tab" aria-controls="profile" aria-selected="false">
                                @if ($cf->tab != "second")
                                Phụ Kiện
                                @else
                    ...
                    <div class="tab-content" id="myTabContent__{{ $cf->cat_2  }}">
                        <div class="tab-pane active" id="tab__mh--{{ $cf->cat_2 }}" role="tabpanel">
                            ...
                            <div class="owl-carousel owl-theme">
                                ...
                                <div class="item">
                                    <x-product.itemgrid type="1" class="prdhome" :message="$m_2" />
                                </div>
                                @endforeach
                            </div>
                        ...
                        <div class="tab-pane" id="tab__aces--{{ $cf->cat_2  }}" role="tabpanel">
                            ...
                            <div class="owl-carousel owl-theme">
                                ...
                                <div class="item">
                                    <x-product.itemgrid type="1" class="prdhome" :message="$aces_2" />
                                </div>
                                @endforeach
                            </div>
                            @else
            ...
            <div class="box__game mt-5">
                <div class="box__game--1">
                    <ul class="nav cat__tab" id="gameTab__{{ $cf->id }}" role="tablist">
                        <x-styletabs type="cat" :cf="$cf" />
                        <li class="" role="presentation">
                            <a class="active active-{{$cf->id }}" data-toggle="tab" href="#tab__gameNew--{{ $cf->id }}"
                                role="tab" aria-controls="home" aria-selected="true">Game Mới</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="  active-{{$cf->id }}" data-toggle="tab" href="#tab__gameHot--{{ $cf->id }}"
                                role="tab" aria-controls="profile" aria-selected="false">
                                Game hot
                            </a>
                        </li>
                        @if ($cf->cat_digital != NULL)
                        <li class="nav-item" role="presentation">
                            <a class="active-{{$cf->id }}" data-toggle="tab" href="#tab__digital--{{ $cf->id }}"
                                role="tab" aria-controls="profile" aria-selected="false">
                    ...
                    <div class="tab-content" id="myTabGame__{{ $cf->id  }}">
                        <div class="tab-pane active" id="tab__gameNew--{{ $cf->id }}" role="tabpanel">
                            ...
                            <div class="owl-carousel owl-theme">
                                ...
                                <div class="item">
                                    <x-product.itemgrid type="1" class="prdhome" :message="$gn" />
                                </div>
                                @endforeach
                            </div>
                            @else
                        ...
                        <div class="tab-pane " id="tab__gameHot--{{ $cf->id }}" role="tabpanel">
                            ...
                            <div class="owl-carousel owl-theme">
                                ...
                                <div class="item">
                                    <x-product.itemgrid type="1" class="prdhome" :message="$gh" />
                                </div>
                                @endforeach
                            </div>
                            @else
                        ...
                        <div class="tab-pane " id="tab__digital--{{ $cf->id }}" role="tabpanel">
                            ...
                            <div class="owl-carousel owl-theme">
                                ...
                                <div class="item">
                                    <x-product.itemgrid type="1" class="prdhome" :message="$dgt" />
                                </div>
                                @endforeach
                            </div>
                            @else
                ...
                <div class="box__game--2 mt-5">
                    <ul class="nav cat__tab" id="gameTabFut__{{ $cf->id }}" role="tablist">
                        ...
                        <li class="" role="presentation">
                            <a class="active active-{{$cf->id }}" data-toggle="tab" href="#tab__gameFut--{{ $cf->id }}"
                    ...
                    <div class="tab-content" id="myTabGameFut__{{ $cf->id  }}">
                        <div class="tab-pane active" id="tab__gameFut--{{ $cf->id }}" role="tabpanel">
                            ...
                            <div class="owl-carousel owl-theme">
                                ...
                                <div class="item">
                                    <x-product.itemgrid type="1" class="prdhome" :message="$gf" />
                                </div>
                                @endforeach
                            </div>
                            @else
            ...
            <div class="box__access mt-5">
                <ul class="nav cat__tab" id="accessTabFut__{{ $cf->id }}" role="tablist">
                    <x-styletabs type="id" :cf="$cf" />
                    <li class="" role="presentation">
                        <a class="active active-{{$cf->id }}" data-toggle="tab" href="#tab__accessFut--{{ $cf->id }}"
                ...
                <div class="tab-content" id="myTabAccessFut__{{ $cf->id  }}">
                    <div class="tab-pane active" id="tab__accessFut--{{ $cf->id }}" role="tabpanel">
                        ...
                        <div class="owl-carousel owl-theme">
                            ...
                            <div class="item">
                                <x-product.itemgrid type="1" class="prdhome" :message="$aci" />
                            </div>
                            @endforeach
                        </div>
                        @else
