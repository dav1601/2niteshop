            ...
            <div class="row w-100 mx-0">
                <div class="col-12 col-lg-6 pl-lg-0 cks_left d-flex flex-column align-items-center">
                    <div class="img d-flex justify-content-center">
                        <img src="{{ $file->ver_img_local('client/images/checked-2.png') }}" alt="icon checked">
                    </div>
                    <div class="box my-3">
                        <div class="box__title d-flex align-items-center">
                            <h3 style="margin-top:12px">Cảm ơn quý khách đã đặt hàng thành công tại <strong>2NITE
                                    SHOP</strong></h3>
                            <img src="{{ $file->ver_img_local('client/images/happy.png') }}" height="30px" class="ml-2"
                                alt="icon happy">
                        </div>
                        <div class="box__content">
                            <span>ID Đơn Hàng Của Quý Khách Là: <strong>{{ $ordered->id }}</strong></span>
                            <span>Chúng tôi sẽ gửi cho bạn 1 email về chi tiết đơn hàng và trạng thái đơn hàng để khách hàng
                                tiện theo dõi.</span>
                            <span>Nếu Khách Hàng cần hỗ trợ liên hệ ngay với E-mail:
                                <strong>{{ getVal('email')->value }}</strong> hoặc Gọi ngay đến:
                                <strong>{{ getVal('switchboard')->value }}</strong> để được hỗ trợ nhanh nhất! Cảm ơn quý
                                khách.</span>
                    ...
                    <div class="cks_right--ordered">
                        ...
                        <div>
                            <div class="row mx-0 mb-3">
                                ...
                                <strong
                                    class="col-6 d-flex justify-content-end pr-4">CALL-{{ getVal('switchboard')->value }}</strong>
                            </div>
                            <div class="row mx-0 mb-3">
                                <span class="col-6 pl-0">Tổng Tiền:</span>
                                <strong class="col-6 d-flex justify-content-end pr-4">{{ crf($ordered->total) }}</strong>
                            </div>
                            <div class="row mx-0">
                                <span class="col-6 pl-0">Ngày đặt</span>
                                <strong class="col-6 d-flex justify-content-end pr-4">{{ $ordered->created_at }}</strong>
                            </div>
                        </div>
                    </div>
                    <div id="info">
