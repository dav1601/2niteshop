...
@section('meta-desc', 'Chuyên trang tin tức bao gồm tin tức mới, đập hộp review các sản phẩm mới, hướng dẫn và thủ thuật
...
@section('og-desc', '2nite shop, 2niteshop, 2nite channel, tin tuc cong nghe, tin tuc game, game moi, game news, tech
            ...
            <div class="row mx-0">
                ...
                <div class="col-12 col-lg-3 pr-lg-0 va-fix-19" id="blog__right">
                    ...
                    <input type="text" name="search" class="form-control w-100" id="search_blog"
                        placeholder="Tìm bài viết" value="@if ($kw != 0) {{ $kw }} @endif">
