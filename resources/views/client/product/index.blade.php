...
<div class="tab-content">
    <div class="tab-pane @if ($view == "grid") active @endif animate__animated animate__zoomIn" id="grid"  role="tabpanel">
     @if (count($products) > 0 )
     <div class="row mx-0" id="outputGrid" >
        {{-- @if( App\Models\Category::where('id', '=' , $id)->first()->is_game == 1 ) col-md-4 @else col-md-3 @endif --}}
    ...
    <div class="tab-pane @if ($view == "list") active @endif animate__animated animate__zoomIn"  id="list" role="tabpanel">
        @if (count($products) > 0 )
    ...
    <div class="box__filter--genre" class="collapse" id="collapseGenre">
     ...
     <div class="form-check mb-3">
        <label class="form-check-label">
          <input type="checkbox" class="form-check-input game_genre" value="{{ $gen->cat_game_id }}" @if (in_array($gen->cat_game_id, $genres)) checked @endif >
          {{ $gen->cat_game_id }}
        </label>
      </div>
     @endif
