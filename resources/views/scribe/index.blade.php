...
<div class="tocify-wrapper">
            ...
            <div class="lang-selector">
                    ...
                    data-language-name="bash">bash</button>
                                            <button type="button" class="lang-button"
                    data-language-name="javascript">javascript</button>
                    </div>
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="auth">
                    <a href="#auth">Auth</a>
                        ...
                        <a
                            href="#auth-POSTapi-auth-login">Login.</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="auth-POSTapi-auth-signup">
                        <a
                            href="#auth-POSTapi-auth-signup">Singup.</a>
                    </li>
                                            </ul>
                </ul>
                ...
                <li class="tocify-item level-1" data-unique="auth-api">
                    <a href="#auth-api">Auth Api</a>
                        ...
                        <a
                            href="#auth-api-POSTapi-auth-logout">Logout.</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="auth-api-GETapi-auth-me--id-">
                        <a
                            href="#auth-api-GETapi-auth-me--id-">GET USER LOGGED.</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="auth-api-GETapi-auth-me-orders--id-">
                        <a
                            href="#auth-api-GETapi-auth-me-orders--id-">GET ORDERS USER LOGGED.</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="auth-api-POSTapi-auth-update--id-">
                        <a
                            href="#auth-api-POSTapi-auth-update--id-">POST UPDATE INFO USER.</a>
                    </li>
                                            </ul>
                </ul>
                ...
                <li class="tocify-item level-1" data-unique="blog">
                    <a href="#blog">Blog</a>
                                    ...
                                    <ul id="tocify-subheader-blog" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="blog-GETapi-blogs-list">
                        <a
                            href="#blog-GETapi-blogs-list">List all blog.</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="blog-GETapi-blogs-blog--slug-">
                        <a
                            href="#blog-GETapi-blogs-blog--slug-">Retrieve a blog.</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="blog-GETapi-blogs-search_blog">
                        <a
                            href="#blog-GETapi-blogs-search_blog">Search Blogs.</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="blog-GETapi-blogs-blog_properties">
                        <a
                            href="#blog-GETapi-blogs-blog_properties">Blog properties.</a>
                    </li>
                                            </ul>
                </ul>
                    <ul id="tocify-header-3" class="tocify-header">
                <li class="tocify-item level-1" data-unique="blogcategories">
                    <a href="#blogcategories">BlogCategories</a>
                </li>
                                    <ul id="tocify-subheader-blogcategories" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="blogcategories-GETapi-blogs-categories-properties">
                        <a
                            href="#blogcategories-GETapi-blogs-categories-properties">Blog category properties.</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="blogcategories-GETapi-blogs-categories-list_all">
                        <a
                            href="#blogcategories-GETapi-blogs-categories-list_all">List all blog categories.</a>
                    </li>
                                            </ul>
                </ul>
                ...
                <li class="tocify-item level-1" data-unique="password">
                    <a href="#password">Password</a>
                                    ...
                                    <ul id="tocify-subheader-password" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="password-POSTapi-auth-reset-passowrd-forgot">
                        <a
                            href="#password-POSTapi-auth-reset-passowrd-forgot">Forgot Password.</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="password-POSTapi-auth-reset-passowrd-verification">
                        <a
                            href="#password-POSTapi-auth-reset-passowrd-verification">Api Verification OTP.</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="password-POSTapi-auth-reset-passowrd-new_password">
                        <a
                            href="#password-POSTapi-auth-reset-passowrd-new_password">Api New Password.</a>
                    </li>
                                            </ul>
                </ul>
                ...
                <li class="tocify-item level-1" data-unique="products">
                    <a href="#products">Products</a>
                                    ...
                                    <ul id="tocify-subheader-products" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="products-GETapi-products-list">
                        <a
                            href="#products-GETapi-products-list">List all products.</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="products-GETapi-products-product--slug-">
                        <a
                            href="#products-GETapi-products-product--slug-">Retrieve a product.</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="products-GETapi-products-search_product">
                        <a
                            href="#products-GETapi-products-search_product">Search Products.</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="products-GETapi-products-product_properties">
                        <a
                            href="#products-GETapi-products-product_properties">Product properties.</a>
                    </li>
                                            </ul>
                </ul>
                    <ul id="tocify-header-6" class="tocify-header">
                <li class="tocify-item level-1" data-unique="productscategories">
                    <a href="#productscategories">ProductsCategories</a>
                </li>
                                    <ul id="tocify-subheader-productscategories" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="productscategories-GETapi-products-categories-properties">
                        <a
                            href="#productscategories-GETapi-products-categories-properties">Product category properties.</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="productscategories-GETapi-products-categories-list_all">
                        <a
                            href="#productscategories-GETapi-products-categories-list_all">List all product categories.</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="productscategories-GETapi-products-categories-game">
                        <a
                            href="#productscategories-GETapi-products-categories-game">List all Game Genre.</a>
                    </li>
                                    <li class="tocify-item level-2" data-unique="productscategories-GETapi-products-categories-producer">
                        <a
                            href="#productscategories-GETapi-products-categories-producer">List all Producer.</a>
                    </li>
                                            </ul>
                </ul>
                ...
                <li class="tocify-item level-1" data-unique="user">
                    <a href="#user">User</a>
                        ...
                        <a
                            href="#user-GETapi-users">GET USERS.</a>
                    </li>
                                            </ul>
                </ul>
...
<pre><code class="language-yaml">https://vachill.com/</code></pre>
...
<p>min:6</p>
            ...
            <h2 id="auth-POSTapi-auth-signup">Singup.</h2>
...
<p>min:6</p>
    ...
    <p>APIs for managing Blog</p>

            <h2 id="blog-GETapi-blogs-list">List all blog.</h2>
...
<p>Default: all</p>
            ...
            <h2 id="blog-GETapi-blogs-blog--slug-">Retrieve a blog.</h2>
...
<span id="example-requests-GETapi-blogs-blog--slug-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-blogs-blog--slug-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-blogs-blog--slug-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-blogs-blog--slug-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-blogs-blog--slug-"></code></pre>
</span>
<span id="execution-error-GETapi-blogs-blog--slug-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-blogs-blog--slug-"></code></pre>
</span>
<form id="form-GETapi-blogs-blog--slug-" data-method="GET"
      data-path="api/blogs/blog/{slug}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      data-headers='[]'
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-blogs-blog--slug-"
                    onclick="tryItOut('GETapi-blogs-blog--slug-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-blogs-blog--slug-"
                    onclick="cancelTryOut('GETapi-blogs-blog--slug-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-blogs-blog--slug-" hidden>Send Request 💥
            </button>
            </h3>
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/blogs/blog/{slug}</code></b>
        </p>
                    <h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
                    <p>
...
<p>The slug of the blog.</p>
    ...
    <br>
            ...
            <h2 id="blog-GETapi-blogs-search_blog">Search Blogs.</h2>
...
<p>Default: all</p>
    ...
    <br>
            ...
            <h2 id="blog-GETapi-blogs-blog_properties">Blog properties.</h2>
...
<p>Trạng thái bài viết (1: được đăng , 2: đã gỡ)</p>
        ...
        <h1 id="blogcategories">BlogCategories</h1>

    <p>APIs for managing BlogCategories</p>

            <h2 id="blogcategories-GETapi-blogs-categories-properties">Blog category properties.</h2>
...
<p>Slug danh mục</p>
            ...
            <h2 id="blogcategories-GETapi-blogs-categories-list_all">List all blog categories.</h2>
...
<form id="form-GETapi-blogs-categories-list_all" data-method="GET"
    ...
    <p>APIs for managing Password</p>

            <h2 id="password-POSTapi-auth-reset-passowrd-forgot">Forgot Password.</h2>
...
<p>max:15</p>
            ...
            <h2 id="password-POSTapi-auth-reset-passowrd-verification">Api Verification OTP.</h2>
...
<p>max:6</p>
            ...
            <h2 id="password-POSTapi-auth-reset-passowrd-new_password">Api New Password.</h2>
...
<p>max:15</p>
    ...
    <p>APIs for managing Products</p>
            ...
            <h2 id="products-GETapi-products-list">List all products.</h2>
...
<p>Default: all</p>
            ...
            <h2 id="products-GETapi-products-product--slug-">Retrieve a product.</h2>
...
<span id="example-requests-GETapi-products-product--slug-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-products-product--slug-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-products-product--slug-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-products-product--slug-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-products-product--slug-"></code></pre>
</span>
<span id="execution-error-GETapi-products-product--slug-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-products-product--slug-"></code></pre>
</span>
<form id="form-GETapi-products-product--slug-" data-method="GET"
      data-path="api/products/product/{slug}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      data-headers='[]'
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-products-product--slug-"
                    onclick="tryItOut('GETapi-products-product--slug-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-products-product--slug-"
                    onclick="cancelTryOut('GETapi-products-product--slug-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-products-product--slug-" hidden>Send Request 💥
            </button>
            </h3>
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/products/product/{slug}</code></b>
        </p>
                    <h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
                    <p>
                <b><code>slug</code></b>&nbsp;&nbsp;<small>string</small>  &nbsp;
                <input type="text"
               name="slug"
               data-endpoint="GETapi-products-product--slug-"
               value="nintendo-switch-oled-model-with-neon-red-blue-joycon"
               data-component="url" hidden>
    <br>
    ...
    <br>
            ...
            <h2 id="products-GETapi-products-search_product">Search Products.</h2>
...
<p>Default: all</p>
    ...
    <br>
            ...
            <h2 id="products-GETapi-products-product_properties">Product properties.</h2>
...
<p>Tên người đăng sản phẩm</p>
        ...
        <h1 id="productscategories">ProductsCategories</h1>

    <p>APIs for managing Products</p>

            <h2 id="productscategories-GETapi-products-categories-properties">Product category properties.</h2>
...
<p>(2: không là danh mục game , 1: là danh mục game)</p>
            ...
            <h2 id="productscategories-GETapi-products-categories-list_all">List all product categories.</h2>
...
<form id="form-GETapi-products-categories-list_all" data-method="GET"
    ...
    <br>
            ...
            <h2 id="productscategories-GETapi-products-categories-game">List all Game Genre.</h2>
...
<form id="form-GETapi-products-categories-game" data-method="GET"
    ...
    <br>
            ...
            <h2 id="productscategories-GETapi-products-categories-producer">List all Producer.</h2>
...
<form id="form-GETapi-products-categories-producer" data-method="GET"
    ...
    <p>APIs for managing users</p>
            ...
            <h2 id="user-GETapi-users">GET USERS.</h2>
