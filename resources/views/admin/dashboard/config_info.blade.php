                ...
                <div class="card">
                    ...
                    <div class="card-body" id="config__home--add">
                        ...
                        <div class="form-group html d-none mb-5">
                            ...
                            <textarea name="value" id="value_config_infor" class="form-control my-editor">{!! old('value') !!}</textarea>
                            @error('value')
                                <div class="alert alert-danger alert-dismissible fade show mt-4" role="alert">
                                    {{ $message }}
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            ...
                            <tbody>
                                @foreach ($config_info as $conf)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('delete_cofinfor_handle', ['id' => $conf->id]) }}"
                                                class="d-block delete_conf" data-id="{{ $conf->id }}">
