                ...
                <div class="w-100">
                    <div class="card">
                        ...
                        <div class="card-body avatar__name text-center">
                            ...
                            <div class="text-muted mb-2"> {!! renderROP($user->roles) !!} </div>
                        </div>
                        <hr>
                        <div class="card-body address">
                            ...
                            <ul id="address" class="about__contact">
                                ...
                                <li class="mb-1">
                                    <span><i class="fa-solid fa-building"></i> Làm việc tại : </span><a href="#">dav1six dev</a>
                                </li>
                                <li class="mb-1">
                                    <span><i class="fa-solid fa-location-dot"></i> Đến Từ : </span><a href="#">
                                        @if ($profile->city != null)
                                            {{ $daviUser->getNameWard($profile->w) }}
                                            , {{ $daviUser->getNameDist($profile->d) }} ,
                ...
                <div class="w-100">
                    <div class="card">
                        ...
                        <div class="card-body" id="wp__activities">
                            ...
                            @if ($number_page > 1)
                                <div id="button">
                                    <button class="btn w-100 navi_btn text-center" id="load__more--activities">Xem
                                        Thêm</button>
                                </div>
                            @endif
                        </div>
