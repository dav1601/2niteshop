                                ...
                                <div class="col-12">
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="text" class="form-control" placeholder="1234 Main St"
                                            name="address_1" value="{{ $profile->address_1 }}" id=""
                                            placeholder="">
                                        @error('address_1')
                                            <div class="alert alert-danger alert-dismissible fade show mt-4" role="alert">
                                                {{ $message }}
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="text" class="form-control" placeholder="Chung cư , studio......"
                                            name="address_2" value="{{ $profile->address_2 }}" id=""
                                            placeholder="">
                                    </div>
                                </div>
                                <div class="col-4">
                                        ...
                                        @else
                                            <select class="custom-select" name="city" id="prov">
                                                <option value="{{ $profile->city }}">
                                                    {{ App\Models\Province::where('id', '=', $profile->city)->first()->_name }}
                                                </option>
                                                @foreach (App\Models\Province::all() as $prov)
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" name="dist" id="dist">
                                            ...
                                            @else
                                                <option value="{{ $profile->d }}">
                                                    {{ App\Models\District::where('id', '=', $profile->d)->first()->_name }}
                                                </option>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" name="ward" id="ward">
                                            ...
                                            @else
                                                <option value="{{ $profile->w }}">
                                                    {{ App\Models\Ward::where('id', '=', $profile->w)->first()->_name }}
                                                </option>
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="text" class="form-control" name="zalo"
                                            value="{{ $profile->zalo }}" id="" placeholder="Có thể để trống">
                                    </div>
                                </div>
                                {{-- --}}
                                {{-- --}}
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="text" class="form-control" name="github"
                                            value="{{ $profile->github }}" id="" placeholder="Có thể để trống">
                                    </div>
                                </div>
                                {{-- --}}
                                {{-- --}}
