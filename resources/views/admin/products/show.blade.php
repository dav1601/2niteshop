...
@section('import_js')
    ...
    <script
        src="{{ asset('admin/app/js/products.js') }}?ver=@php echo filemtime('public/admin/app/js/category.js') @endphp">
    </script>
                            ...
                            <div class="form-group">
                                ...
                                <div class="box_output mt-3">
                                    <span>Mặc định:<strong
                                            class="pl-2">{{ crf(App\Models\Products::min('price')) }}</strong></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-3 mb-4">
                            <div class="form-group">
                                ...
                                <div class="box_output mt-3">
                                    <span>Mặc định:<strong
                                            class="pl-2">{{ crf(App\Models\Products::max('price')) }}</strong></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-2 mb-4 pl-0">
            ...
            <div class="w-100">
                <div class="card">
                    ...
                    <div class="card-footer" id="product__show--page">
                        {!! navi_ajax_page($products->number_page, 1, '', 'justify-content-center', 'mt-2') !!}
                    </div>
                </div>
            </div>
        </div>
