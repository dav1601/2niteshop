                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-5">
                            ...
                            <textarea type="text" class="form-control" name="desc" id=""
                                placeholder="Description danh mục">{{ old('desc') }}</textarea>
                            @error('desc')
                            <div class="alert alert-danger mt-4 alert-dismissible fade show" role="alert">
                                {{ $message }}
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select class="custom-select" name="parent" id="">
                                ...
                                <option value="{{ $cat->id }}">{{ str_repeat('--' , $cat->level) }} {{ $cat->name }}
                                </option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (empty($cate->img))
                                        <img src="{{ asset('admin/layout/no.png') }}" width="250" height="100"
                                            class="va-radius-fb" alt="">
                                        @else
                                        <img src="{{ asset($cate->img) }}" width="400" height="100" class="va-radius-fb"
                                            alt="">
                                        @endif
                                    </td>
                                    <td>
                                        @if (empty($cate->icon))
                                        <img src="{{ asset('admin/layout/no.png') }}" width="60" height="60"
                                            class="va-radius-fb" alt="">
                                        @else
                                        <img src="{{ asset($cate->icon) }}" class="va-radius-fb" alt="">
                                        @endif
                                    </td>
                                    <td>
