...
<li class="hm__item lv-<?php echo e($category->level); ?>" data-lv=<?php echo e($category->level); ?>>
    ...
    <a href="<?php echo e(url('category/'.App\Models\Category::createUriCategory(App\Models\Category::ParentTree($category->id)))); ?>">
        <div class="icon-name">
...
<li class="hm__item lv-<?php echo e($category_120->level); ?>" data-lv=<?php echo e($category_120->level); ?>>
    <a href="<?php echo e(url('category/'.App\Models\Category::createUriCategory(App\Models\Category::ParentTree(120)))); ?>">
        <div class="icon-name">
