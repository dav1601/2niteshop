<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if($category->id != 120): ?>
        <li class="hm__item lv-<?php echo e($category->level); ?>" data-lv=<?php echo e($category->level); ?>>
            ...
            <a
                href="<?php echo e(url('category/' . App\Models\Category::createUriCategory(App\Models\Category::ParentTree($category->id)))); ?>">
                <div class="icon-name">
                    <?php if($category->parent_id == 0): ?>
                        <img src="<?php echo e($file->ver_img($category->icon)); ?>" width="25" height="25"
...
<?php $component = App\View\Components\Client\Menu\Category::resolve(['category' => $category->children] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('client.menu.category'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Client\Menu\Category::class))->getConstructor()): ?>
        ...
        <?php if($loop->last && $category->level == 0): ?>
            ...
            <li class="hm__item">
                <a href="<?php echo e(url('tin-tuc')); ?>">
                    <div class="icon-name">
                        <img src="<?php echo e($file->ver_img_local('admin/images/category/icon/news.png')); ?>" width="25"
    ...
    <?php if($category->id == 112): ?>
        ...
        <?php $__currentLoopData = $categories_120; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category_120): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="hm__item lv-<?php echo e($category_120->level); ?>" data-lv=<?php echo e($category_120->level); ?>>
                <a
                    href="<?php echo e(url('category/' . App\Models\Category::createUriCategory(App\Models\Category::ParentTree(120)))); ?>">
                    <div class="icon-name">
                        <img src="<?php echo e($file->ver_img_local('admin/images/category/icon/icons8-nintendo-switch-logo-64.png')); ?>"
                            width="25" height="25" alt="<?php echo e($category_120->name); ?>">
                ...
                <?php if(count($category_120->children) > 0): ?>
                    <ul class="sub__menu lv-<?php echo e($category_120->level + 1); ?>">
                        <?php if (isset($component)) { $__componentOriginal1b334014b5062e2721d0c0606efeebec0019426e = $component; } ?>
<?php $component = App\View\Components\Client\Menu\Category::resolve(['category' => $category_120->children] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('client.menu.category'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Client\Menu\Category::class))->getConstructor()): ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH E:\xampp\htdocs\2niteshop\home\u217861923\domains\vachill.com\public_html\resources\views/components/client/menu/categories.blade.php ENDPATH**/ ?>