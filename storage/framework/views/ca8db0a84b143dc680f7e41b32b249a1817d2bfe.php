...
<?php $__env->startSection('import_js'); ?>
    ...
    <script
        src="<?php echo e($file->ver_img('admin/app/js/tinymce.js')); ?>?ver=<?php echo filemtime('admin/app/js/tinymce.js') ?>">
    </script>
...
<?php endif; ?>
                        ...
                        <div class="row mx-0">
                            <?php if (isset($component)) { $__componentOriginal19571530086391dd0a770e0cef2481dd23608ab5 = $component; } ?>
<?php $component = App\View\Components\Admin\Form\File::resolve(['class' => 'col-6 mb-5 pl-0','name' => 'banner','id' => 'bannerProduct','custom' => [
