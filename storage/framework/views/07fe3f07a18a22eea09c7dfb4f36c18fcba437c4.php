                ...
                <div class="dtl__prd--left col-md-6 p-0">
                    <div class="w-100 position-relative">
                        ...
                        <ul id="vertical">
                            ...
                            ?>
                            <li data-thumb="<?php echo e($file->ver_img($link_80)); ?>?now=<?php echo e($carbon->now()->timestamp); ?>" alt="<?php echo e($product->name); ?>">
                                <img src="<?php echo e($file->ver_img($gll->link)); ?>?now=<?php echo e($carbon->now()->timestamp); ?>" alt="<?php echo e($product->name); ?>"/>
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.productlabels','data' => ['product' => $product]]); ?>
...
<?php endif; ?>
                    ...
                    <div class="w-100 banner__video">
                        ...
                        <div class="prd__banner">
                            <a href="<?php echo e(url($product->banner_link)); ?>" class="d-block">
                                <img src="<?php echo e($file->ver_img($product->banner)); ?>" class="img-fluid" alt="<?php echo e($product->name); ?>">
                            </a>
                        </div>
                        <?php endif; ?>
                ...
                <div class="dtl__prd--right col-md-6 pr-0">
                    <div class="w-100" id="prd" class="prd__dtl">
                        ...
                        <div class="prd__dtl--insur">
                            <span class="d-block"><?php echo e($group == 1 ? "Chọn thời gian bảo hành":"Chọn phụ kiện mua kèm"); ?>: <strong>*</strong></span>
                            <ul class="insur">
        ...
        <div class="w-100 dtl__bundled">
            ...
            <ul class="nav cat__tab" id="myTab__bundled" role="tablist">
                ...
                <?php if($bundled->bundled_skin != NULL): ?>
            ...
            <div class="tab-content" id="myTabContent__bundled">
                <div class="tab-pane active" id="tab__aces" role="tabpanel">
                    <?php if(count($bundled_a) > 0): ?>
                    <div class="owl-carousel owl-theme owl-6">
                        <?php $__currentLoopData = $bundled_a; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aces): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        $m = App\Models\Products::where('id', '=' , $aces)->first();
                        ?>
                        <div class="item">
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.product.itemgrid','data' => ['type' => '2','class' => 'prddetail','message' => $m]]); ?>
<?php $component->withName('product.itemgrid'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['type' => '2','class' => 'prddetail','message' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($m)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                ...
                <div class="tab-pane" id="tab__skin" role="tabpanel">
                    ...
                    <div class="owl-carousel owl-theme owl-6">
                        ...
                        <div class="item">
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.product.itemgrid','data' => ['type' => '2','class' => 'prddetail','message' => $aces]]); ?>
<?php $component->withName('product.itemgrid'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['type' => '2','class' => 'prddetail','message' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($aces)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
            ...
            <div class="tab-content" id="dtlTabsGamesContent">
                <div class="tab-pane active" id="tab__games" role="tabpanel">
                    ...
                    <div class="owl-carousel owl-theme owl-6">
                        ...
                        <div class="item">
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.product.itemgrid','data' => ['type' => '2','class' => 'prddetail','message' => $game]]); ?>
<?php $component->withName('product.itemgrid'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['type' => '2','class' => 'prddetail','message' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($game)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
            ...
            <div class="tab-content" id="dtlTabsRelateContent">
                <div class="tab-pane active" id="tab__relate" role="tabpanel">
                    <?php if(count($relate_products) > 0): ?>
                    <div class="owl-carousel owl-theme owl-6">
                        <?php $__currentLoopData = $relate_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rlp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        $prd = App\Models\Products::where('id', '=' , $rlp)->first();
                        ?>
                        <?php if($rlp != $product ->id): ?>
                        <div class="item">
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.product.itemgrid','data' => ['type' => '2','class' => 'prddetail','message' =>  $prd]]); ?>
<?php $component->withName('product.itemgrid'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['type' => '2','class' => 'prddetail','message' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute( $prd)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
                    ...
                    <div class="tab-content" id="myTabContent__blogs">
                        <div class="tab-pane active" id="tab__blogs" role="tabpanel">
                            <div class="owl-carousel owl-theme owl-6">
                                ...
                                <div class="item">
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.blogsubitem','data' => ['blog' => $blog]]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u217861923/domains/vachill.com/public_html/resources/views/client/product/detail.blade.php ENDPATH**/ ?>