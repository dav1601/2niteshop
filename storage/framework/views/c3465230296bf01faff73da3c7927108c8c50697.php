                    ...
                    <div class="accordion" id="sidebar__content--accordion">
                        <ul class="sidebar__content--menu">
                            <li class="module">
                                ...
                                <div id="dashboard"
                                    class="collapse module_drop <?php echo e($module == 'dashboard' ? 'show' : ''); ?>"
                            ...
                            <li class="module">
                                ...
                                <div id="user"
                                    class="collapse module_drop <?php echo e($module == 'users' ? 'show' : ''); ?>"
                                    data-parent="#sidebar__content--accordion">
                                    <ul class="module__drop--menu">
                                        <li class="item">
                            ...
                            <li class="module">
                                ...
                                <div id="order"
                                    class="collapse module_drop <?php echo e($module == 'orders' ? 'show' : ''); ?>"
                                    data-parent="#sidebar__content--accordion">
                                    <ul class="module__drop--menu">
                                        <li class="item">
                            ...
                            <li class="module">
                                ...
                                <div id="blog"
                                    class="collapse module_drop <?php echo e($module == 'blog' ? 'show' : ''); ?>"
                                    data-parent="#sidebar__content--accordion">
                                    <ul class="module__drop--menu">
                                        <li class="item">
                            ...
                            <li class="module">
                                ...
                                <div id="banner"
                                    class="collapse module_drop <?php echo e($module == 'banner' ? 'show' : ''); ?>"
                                    data-parent="#sidebar__content--accordion">
                                    <ul class="module__drop--menu">
                                        <li class="item">
                            ...
                            <li class="module">
                                ...
                                <div id="page"
                                    class="collapse module_drop <?php echo e($module == 'pages' ? 'show' : ''); ?>"
                                    data-parent="#sidebar__content--accordion">
                                    <ul class="module__drop--menu">
                                        <li class="item">
