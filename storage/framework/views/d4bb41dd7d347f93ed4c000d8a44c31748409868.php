...
<?php endif; ?>
    <div class="product__item--img" data-id="<?php echo e($message->id); ?>">
        <a href="<?php echo e(route('detail_product', ['slug'=>$message->slug])); ?>" class="d-block img_show">
            <img src="<?php echo e($file->ver($message->main_img)); ?>" alt="<?php echo e($message->name); ?>" class="img-fluid">
        </a>
        <a href="<?php echo e(route('detail_product', ['slug'=>$message->slug])); ?>" class="d-none img_hide">
            <img src="<?php echo e($file->ver($message->sub_img)); ?>" alt="<?php echo e($message->name); ?>" class="img-fluid">
        </a>
...
<?php /**PATH E:\xampp\htdocs\nava\resources\views\components\productitem.blade.php ENDPATH**/ ?>