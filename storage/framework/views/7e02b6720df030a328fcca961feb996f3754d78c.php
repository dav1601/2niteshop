        ...
        <div class="home__right">
                        ...
                        <div class="carousel-item active">
                            <a href="<?php echo e(url($slide->link)); ?>" class="d-block">
                                <img  class="d-block w-100 img-fluid lazy"
                                    alt="<?php echo e($slide->name); ?>"   src="<?php echo e($file->ver_img($slide->img)); ?>" >
                            </a>
                        </div>
                        <?php else: ?>
            ...
            <div class="home__right--banner">
                ...
                <a href="<?php echo e(url($bn->link)); ?>" class="d-block">
                    <img src="<?php echo e($file->ver_img($bn->img)); ?>"  class="lazy" alt="<?php echo e($bn->name); ?>" width="100%" height="auto"
    ...
    <div class="w-100  owl-carousel owl-theme mb-4">
        <div class="item">
            <a  class="d-block w-100">
                <img src="<?php echo e($file->ver_img('client/images/plc-1.png')); ?>"  class="img-fluid lazy" alt="<?php echo e($bt->name); ?>">
            </a>
        </div>
        <div class="item">
            <a  class="d-block w-100">
                <img  src="<?php echo e($file->ver_img('client/images/plc-2.png')); ?>"  class="img-fluid lazy" alt="<?php echo e($bt->name); ?>">
            </a>
        </div>
        <div class="item">
            <a  class="d-block w-100">
                <img src="<?php echo e($file->ver_img('client/images/plc-3.png')); ?>"  class="img-fluid lazy" alt="<?php echo e($bt->name); ?>">
            </a>
        </div>
        <div class="item">
            <a  class="d-block w-100">
                <img src="<?php echo e($file->ver_img('client/images/plc-4.png')); ?>"  class="img-fluid lazy" alt="<?php echo e($bt->name); ?>">
            </a>
        </div>
    </div>
            ...
            <div class="box__banner">
                <div class="box__banner--main">
                    <a href="<?php echo e(url($cf->main_link)); ?>" class="d-block">
                        <img   src="<?php echo e($file->ver_img($cf->main_img)); ?>" alt="<?php echo e($cf->name); ?>" class="img-fluid lazy">
                    </a>
                </div>
                <div class="box__banner--sub owl-carousel owl-theme">
                    ...
                    <div class="item pl-0">
                        <a href="<?php echo e($cf->use_link); ?>" class="d-block">
                            <img  src="<?php echo e($file->ver_img($cf->use_img)); ?>" alt="<?php echo e($cf->name); ?>" class="img-fluid lazy">
                        </a>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="item">
                        <a href="<?php echo e($cf->instruct_link); ?>" class="d-block">
                            <img  src="<?php echo e($file->ver_img($cf->instruct_img)); ?>" alt="<?php echo e($cf->name); ?>" class="img-fluid lazy">
                        </a>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="item">
                        <a href="<?php echo e($cf->access_link); ?>" class="d-block">
                            <img  src="<?php echo e($file->ver_img($cf->access_img)); ?>" alt="<?php echo e($cf->name); ?>" class="img-fluid lazy">
                        </a>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="item pr-0">
                        <a href="<?php echo e($cf->fix_link); ?>" class="d-block">
                            <img  src="<?php echo e($file->ver_img($cf->fix_img)); ?>" alt="<?php echo e($cf->name); ?>" class="img-fluid lazy">
                        </a>
                    </div>
                    <?php endif; ?>
                </div>
