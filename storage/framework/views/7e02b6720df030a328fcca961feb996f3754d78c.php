...
<?php $__env->startSection('banner'); ?>
    <div class="banner">
        <a href="<?php echo e(url($banner->link)); ?>" class="d-block">
            <img src="<?php echo e($file->ver_img($banner->img)); ?>" alt="<?php echo e($banner->name); ?>" class="img-fluid lazy">
        </a>
    </div>
<?php $__env->stopSection(); ?>
                    ...
                    <div class="box__banner">
                        <div class="box__banner--main">
                            <a href="<?php echo e(url($cf->main_link)); ?>" class="d-block">
                                <img src="<?php echo e($file->ver_img($cf->main_img)); ?>" alt="<?php echo e($cf->name); ?>"
                            ...
                            <?php if($cf->use_img != null): ?>
                                <div class="item pl-0">
                                    <a href="<?php echo e($cf->use_link); ?>" class="d-block">
                                        <img src="<?php echo e($file->ver_img($cf->use_img)); ?>" alt="<?php echo e($cf->name); ?>"
                                            class="img-fluid lazy">
                                    </a>
                                </div>
                            <?php endif; ?>
                            <?php if($cf->instruct_img != null): ?>
                                <div class="item">
                                    <a href="<?php echo e($cf->instruct_link); ?>" class="d-block">
                                        <img src="<?php echo e($file->ver_img($cf->instruct_img)); ?>" alt="<?php echo e($cf->name); ?>"
                                            class="img-fluid lazy">
                                    </a>
                                </div>
                            <?php endif; ?>
                            <?php if($cf->access_img != null): ?>
                                <div class="item">
                                    <a href="<?php echo e($cf->access_link); ?>" class="d-block">
                                        <img src="<?php echo e($file->ver_img($cf->access_img)); ?>" alt="<?php echo e($cf->name); ?>"
                                            class="img-fluid lazy">
                                    </a>
                                </div>
                            <?php endif; ?>
                            <?php if($cf->fix_img != null): ?>
                                <div class="item pr-0">
                                    <a href="<?php echo e($cf->fix_link); ?>" class="d-block">
                                        <img src="<?php echo e($file->ver_img($cf->fix_img)); ?>" alt="<?php echo e($cf->name); ?>"
                                            class="img-fluid lazy">
                                    </a>
                                </div>
                            <?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.styletabs','data' => ['type' => 'cat','cf' => $cf]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                    <li class="nav-item" role="presentation">
                                        <a class="active active-<?php echo e($cf->cat); ?>" data-toggle="tab"
                                            href="#tab__mh--<?php echo e($cf->id); ?>" role="tab" aria-controls="home"
                                            aria-selected="true">Máy
                                            <?php echo e(App\Models\Category::where('id', '=', $cf->cat)->first()->name); ?></a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="active-<?php echo e($cf->cat); ?>" data-toggle="tab"
                                            href="#tab__aces--<?php echo e($cf->id); ?>" role="tab"
...
<?php $component = App\View\Components\Product\Itemgrid::resolve(['type' => '1','class' => 'prdhome','message' => $m] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                                        ...
                                        <?php if(count($access) > 0): ?>
                                            <div class="owl-carousel owl-theme">
                                                <?php $__currentLoopData = $access; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aces): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="item">
                                                        <?php if (isset($component)) { $__componentOriginal58ee110754c547cdf765a6d10246c95d9c380967 = $component; } ?>
<?php $component = App\View\Components\Product\Itemgrid::resolve(['type' => '1','class' => 'prdhome','message' => $aces] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('product.itemgrid'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Product\Itemgrid::class))->getConstructor()): ?>
...
<?php endif; ?>
                                        ...
                                        <?php if($cf->option != null): ?>
                                            <?php $__currentLoopData = $option; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $op): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="item">
                                                    <?php if (isset($component)) { $__componentOriginal58ee110754c547cdf765a6d10246c95d9c380967 = $component; } ?>
<?php $component = App\View\Components\Product\Itemgrid::resolve(['type' => '1','class' => 'prdhome','message' => $prd] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('product.itemgrid'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Product\Itemgrid::class))->getConstructor()): ?>
                            ...
                            <div class="box__cat--item --item-2 mt-5">
                                <?php if($cf->tab != 'none'): ?>
                                    ...
                                    <ul class="nav cat__tab" id="myTab__<?php echo e($cf->cat_2); ?>" role="tablist">
                                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.styletabs','data' => ['type' => 'cat_2','cf' => $cf]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('styletabs'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
...
<?php endif; ?>
                                        <li class="" role="presentation">
                                            <a class="active active-<?php echo e($cf->cat_2); ?>" data-toggle="tab"
                                                ...
                                                aria-selected="true">Máy
                                                <?php echo e(App\Models\Category::where('id', '=', $cf->cat_2)->first()->name); ?></a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="active-<?php echo e($cf->cat_2); ?>" data-toggle="tab"
                                                href="#tab__aces--<?php echo e($cf->cat_2); ?>" role="tab"
                                                aria-controls="profile" aria-selected="false">
                                                <?php if($cf->tab != 'second'): ?>
                                                    Phụ Kiện
                                                <?php else: ?>
                                            ...
                                            <?php if(count($machine_2) > 0): ?>
                                                <div class="owl-carousel owl-theme">
                                                    <?php $__currentLoopData = $machine_2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m_2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="item">
                                                            <?php if (isset($component)) { $__componentOriginal58ee110754c547cdf765a6d10246c95d9c380967 = $component; } ?>
<?php $component = App\View\Components\Product\Itemgrid::resolve(['type' => '1','class' => 'prdhome','message' => $m_2] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('product.itemgrid'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Product\Itemgrid::class))->getConstructor()): ?>
                                            ...
                                            <?php if(count($access_2) > 0): ?>
                                                <div class="owl-carousel owl-theme">
                                                    <?php $__currentLoopData = $access_2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aces_2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="item">
                                                            <?php if (isset($component)) { $__componentOriginal58ee110754c547cdf765a6d10246c95d9c380967 = $component; } ?>
<?php $component = App\View\Components\Product\Itemgrid::resolve(['type' => '1','class' => 'prdhome','message' => $aces_2] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('product.itemgrid'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Product\Itemgrid::class))->getConstructor()): ?>
...
<?php endif; ?>
                                <li class="" role="presentation">
                                    <a class="active active-<?php echo e($cf->id); ?>" data-toggle="tab"
                                        href="#tab__gameNew--<?php echo e($cf->id); ?>" role="tab" aria-controls="home"
                                        aria-selected="true">Game Mới</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="active-<?php echo e($cf->id); ?>" data-toggle="tab"
                                        href="#tab__gameHot--<?php echo e($cf->id); ?>" role="tab" aria-controls="profile"
                                        aria-selected="false">
                                        Game hot
                                    </a>
                                </li>
                                <?php if($cf->cat_digital != null): ?>
                                    <li class="nav-item" role="presentation">
                                        <a class="active-<?php echo e($cf->id); ?>" data-toggle="tab"
                                            href="#tab__digital--<?php echo e($cf->id); ?>" role="tab"
                                            aria-controls="profile" aria-selected="false">
                                    ...
                                    <?php if(count($game_new) > 0): ?>
                                        <div class="owl-carousel owl-theme">
                                            <?php $__currentLoopData = $game_new; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="item">
                                                    <?php if (isset($component)) { $__componentOriginal58ee110754c547cdf765a6d10246c95d9c380967 = $component; } ?>
<?php $component = App\View\Components\Product\Itemgrid::resolve(['type' => '1','class' => 'prdhome','message' => $gn] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('product.itemgrid'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Product\Itemgrid::class))->getConstructor()): ?>
                                    ...
                                    <?php if(count($game_hot) > 0): ?>
                                        <div class="owl-carousel owl-theme">
                                            <?php $__currentLoopData = $game_hot; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gh): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="item">
                                                    <?php if (isset($component)) { $__componentOriginal58ee110754c547cdf765a6d10246c95d9c380967 = $component; } ?>
<?php $component = App\View\Components\Product\Itemgrid::resolve(['type' => '1','class' => 'prdhome','message' => $gh] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('product.itemgrid'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Product\Itemgrid::class))->getConstructor()): ?>
                                        ...
                                        <?php if(count($digital) > 0): ?>
                                            <div class="owl-carousel owl-theme">
                                                <?php $__currentLoopData = $digital; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dgt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="item">
                                                        <?php if (isset($component)) { $__componentOriginal58ee110754c547cdf765a6d10246c95d9c380967 = $component; } ?>
<?php $component = App\View\Components\Product\Itemgrid::resolve(['type' => '1','class' => 'prdhome','message' => $dgt] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('product.itemgrid'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Product\Itemgrid::class))->getConstructor()): ?>
...
<?php endif; ?>
                        ...
                        <div class="box__game--2 mt-5">
                            <ul class="nav cat__tab" id="gameTabFut__<?php echo e($cf->id); ?>" role="tablist">
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.styletabs','data' => ['type' => 'id','cf' => $cf]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('styletabs'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
...
<?php endif; ?>
                                <li class="" role="presentation">
                                    <a class="active active-<?php echo e($cf->id); ?>" data-toggle="tab"
                                        href="#tab__gameFut--<?php echo e($cf->id); ?>" role="tab" aria-controls="home"
                                    ...
                                    <?php if(count($game_future) > 0): ?>
                                        <div class="owl-carousel owl-theme">
                                            <?php $__currentLoopData = $game_future; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="item">
                                                    <?php if (isset($component)) { $__componentOriginal58ee110754c547cdf765a6d10246c95d9c380967 = $component; } ?>
<?php $component = App\View\Components\Product\Itemgrid::resolve(['type' => '1','class' => 'prdhome','message' => $gf] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('product.itemgrid'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Product\Itemgrid::class))->getConstructor()): ?>
...
<?php endif; ?>
                                <li class="" role="presentation">
                                    <a class="active active-<?php echo e($cf->id); ?>" data-toggle="tab"
                                        href="#tab__accessFut--<?php echo e($cf->id); ?>" role="tab" aria-controls="home"
                                    ...
                                    <?php if(count($access_items) > 0): ?>
                                        <div class="owl-carousel owl-theme">
                                            <?php $__currentLoopData = $access_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aci): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="item">
                                                    <?php if (isset($component)) { $__componentOriginal58ee110754c547cdf765a6d10246c95d9c380967 = $component; } ?>
<?php $component = App\View\Components\Product\Itemgrid::resolve(['type' => '1','class' => 'prdhome','message' => $aci] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('product.itemgrid'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Product\Itemgrid::class))->getConstructor()): ?>
                ...
                <div class="tab-content" id="myTabContent__blogs">
                    <div class="tab-pane active" id="tab__blogs" role="tabpanel">
                        <div class="owl-carousel owl-theme owl-6">
                            <?php $__currentLoopData = App\Models\Blogs::select('id', 'title', 'slug', 'desc', 'img', 'cat_id', 'cat_sub_id', 'author', 'views', 'active', 'created_at', 'updated_at')->where('active', '=', 1)->orderBy('id', 'DESC')->limit(8)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="item">
                                    <?php if (isset($component)) { $__componentOriginalf39f559c5285947744fdc35c8c7b2100bbecdeab = $component; } ?>
<?php $component = App\View\Components\Blogsubitem::resolve(['blog' => $invo] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
