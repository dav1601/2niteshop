...
<?php $component = App\View\Components\Client\Menu\Categories::resolve(['categories' => $categories] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
