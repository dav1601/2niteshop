...
<div class="d-flex">
    <a href="<?php echo e(route('detail_product', ['slug'=>$item->slug])); ?>" class="success__add--img">
        <img src="<?php echo e($file->ver_img($item->main_img)); ?>" alt=" <?php echo e($item->name); ?> ">
    </a>
...
<?php /**PATH E:\xampp\htdocs\2niteshop\home\u217861923\domains\vachill.com\public_html\resources\views/components/addcart.blade.php ENDPATH**/ ?>