...
<?php $__env->startSection('meta-desc' , "Chuyên trang tin tức bao gồm tin tức mới, đập hộp review các sản phẩm mới, hướng dẫn và thủ thuật sử dụng các sản phẩm công nghệ, game và tin khuyến mãi,... tại HALO SHOP."); ?>
...
<?php $__env->startSection('og-desc' , "2nite shop, 2niteshop, 2nite channel, tin tuc cong nghe, tin tuc game, game moi, game news, tech news, game hot, review, unbox, iphone moi, macbook moi, surface moi, tips, huong dan va thu thuat"); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Blogitem::class, ['blog' => $blog,'cat' => $cat]); ?>
...
<div class="col-12 col-lg-3 pr-lg-0 va-fix-19" id="blog__right">
    ...
    <input type="text" name="search" class="form-control w-100" id="search_blog" placeholder="Tìm bài viết" value="<?php if($kw != 0 ): ?> <?php echo e($kw); ?> <?php endif; ?>">
