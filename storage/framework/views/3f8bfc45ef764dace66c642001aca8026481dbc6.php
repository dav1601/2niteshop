...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="accordion col-6 pl-0" id="accordionExample">
                                <div class="card">
                                    ...
                                    <div id="collapseOne" class="collapse  <?php if(count($array_pc) > 0): ?> show <?php endif; ?>" aria-labelledby="headingOne"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="va-checkbox d-flex align-items-center w-100"
                                                ...
                                                <input type="checkbox" name="categories[]"
                                                    ...
                                                    class="check_ins" <?php echo e(in_array($cate_other->id , $array_pc) ?"checked":""); ?>>
                            ...
                            <div class="mb-4 col-3 cis_item">
                                <div class="va-checkbox d-flex align-items-center w-100">
                                    <input type="checkbox" name="ins[]" value="<?php echo e($in -> id); ?>" id="ci__<?php echo e($in -> id); ?>"
                                        class="check_ins" <?php if(in_array($in->id, $product_ins)): ?>
                                    checked
                                    <?php endif; ?>>
                            ...
                            <div class="mb-4 col-3 plc_item">
                                <div class="va-checkbox d-flex align-items-center w-100">
                                    <input type="checkbox" name="plc[]" value="<?php echo e($plc -> id); ?>"
                                        id="plc__<?php echo e($plc -> id); ?>" class="check_plc" <?php if(in_array($plc->id,
                                    $product_policies)): ?>
                                    checked
                                    <?php endif; ?>>
