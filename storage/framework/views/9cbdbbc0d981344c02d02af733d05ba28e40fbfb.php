                    ...
                    <div class="sort d-flex align-items-center">
                        ...
                        <select class="" name="sort" data-view="<?php echo e($view); ?>" id="sort" data-id="<?php echo e($id); ?>">
                            ...
                            <option value="price" ord="DESC" <?php if($sort=="price" && $ord=="DESC" ): ?> selected <?php endif; ?>>Giá
                                cao > thấp</option>
                            <option value="name" ord="ASC" <?php if($sort=="name" && $ord=="ASC" ): ?> selected <?php endif; ?>>Từ A-Z
                            </option>
                            <option value="name" ord="DESC" <?php if($sort=="name" && $ord=="DESC" ): ?> selected <?php endif; ?>>Từ Z-A
                            </option>
                        </select>
                    </div>
                </div>
