...
<div class="scene">
    ...
    <div class="text">
      ...
      <span class="msg">Bạn không đủ quyền thể thực hiện chức năng này!</span>
      <span class="support">
        
        <a href="<?php echo e(route('dashboard')); ?>">Quay Lại</a>
      </span>
    </div>
    <div class="lock"></div>
  </div>
...
<?php /**PATH E:\xampp\htdocs\nava\resources\views\errors\403.blade.php ENDPATH**/ ?>