        ...
        <div class="w-100">
            <div class="card">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="text-right"
                                    style="font-size: 20px; color:#1dd1a1; font-weight:700"><?php echo e(crf($ordered->total)); ?>
                ...
                <div class="card-footer">
                    <?php if($ordered->status==3): ?>
                    <a data-id="<?php echo e($ordered->id); ?>"
                        class="invoice-<?php echo e($ordered->id); ?> btn navi_btn w-100 mb-4 text-center export_invoice">
