...
<?php $__env->startSection('import_js'); ?>
    ...
    <script src="<?php echo e(asset('admin/app/js/chart.js')); ?>?ver=<?php echo filemtime('admin/app/js/chart.js') ?>"></script>
<?php $__env->stopSection(); ?>
                    ...
                    <div class="card --main">
                        ...
                        <div class="card-body">
                            <div class="row card__users mx-0">
                                <?php $__currentLoopData = App\Models\User::where('role_id', '>', 3)->where('id', '!=', Auth::id())->orderBy('id', 'DESC')->limit(8)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div
                                        ...
                                        <div class="va-checkbox">
                                            <input type="checkbox" name="" id="tk-<?php echo e($task->id); ?>"
                                                class="task__item--check" data-id="<?php echo e($task->id); ?>"
                                                <?php if($task->done == 1): ?> checked <?php endif; ?>>
                                            <label for="tk-<?php echo e($task->id); ?>"><?php echo e($task->name); ?> <?php if($task->done == 1): ?>
                                                    <span class="badge badge-success">Hoàn Thành</span>
                                                <?php else: ?>
                                                    <?php if($task->time_end > $now): ?>
                                                        <span class="badge badge-warning">Còn
                                                            <?php echo e(timeDiff($now, $task->time_end)); ?></span>
                                                    <?php else: ?>
