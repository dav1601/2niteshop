<head>
    ...
    *[x-apple-data-detectors],
    ...
    <?php echo e($text); ?>,<?php echo e($subject); ?>
    ...
    <tbody>
    <tr>
    <td class="section_wrapper_th" style="mso-line-height-rule: exactly; padding-top: 52px;" bgcolor="#ffffff">
    ...
    <!-- Logo : BEGIN -->
    <a href="<?php echo e(url('')); ?>" target="_blank" style="color: #c3c3c3; text-decoration: none !important; text-underline: none;">
    <img src="<?php echo e($file->ver_img('client/images/email-logo.png')); ?> " class="logo" width="200" border="0" style="width: 200px; height: auto !important; display: block; text-align: center; margin: auto;" />
    </a>
    <!-- Logo : END -->
    </th>
    </tr>
    ...
    <tr>
    <td
    class="esdev-adapt-off es-m-p10"
    align="left"
    ...
    cellspacing="0"
    width="100%"
    bgcolor="<?php if($order->status == 1): ?> #f6e6cb <?php else: ?> #efefef <?php endif; ?>"
    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px; background-color: <?php if($order->status == 1): ?> #f6e6cb <?php else: ?> #efefef <?php endif; ?>;"
    role="presentation"
    >
    <tbody style="height: 117px;">
    <tr>
    <?php if($order->status >= 1 ): ?>
    <td align="center" style="padding: 0; margin: 0; padding-top: 10px; padding-left: 15px; padding-right: 15px; font-size: 0px;">
    <a target="_blank" href="#" style="-webkit-text-size-adjust: none; -ms-text-size-adjust: none; mso-line-height-rule: exactly; text-decoration: underline; color: #926b4a; font-size: 14px;">
    <img
    ...
    cellspacing="0"
    width="100%"
    bgcolor="<?php if($order->status == 2): ?> #f6e6cb <?php else: ?> #efefef <?php endif; ?>"
    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px; background-color: <?php if($order->status == 2): ?> #f6e6cb <?php else: ?> #efefef <?php endif; ?>;"
    role="presentation"
    >
    <tbody style="height: 117px;">
    <tr>
    ...
    <td align="center" style="margin: 0; padding-left: 10px; padding-right: 10px; padding-top: 15px; padding-bottom: 20px;">
    <p style="margin: 0; -webkit-text-size-adjust: none; -ms-text-size-adjust: none; mso-line-height-rule: exactly; font-family: arial, 'helvetica neue', helvetica, sans-serif; line-height: 21px; color: #666666; font-size: 14px;">
    Đã Vận Chuyển <?php if($order->status >= 2): ?> <br /> <?php echo e($order->date_ship); ?> <?php endif; ?>
    </p>
    </td>
    </tr>
    </tbody>
    ...
    cellspacing="0"
    width="100%"
    bgcolor="<?php if($order->status == 3): ?> #f6e6cb <?php else: ?> #efefef <?php endif; ?>"
    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px; background-color: <?php if($order->status == 3): ?> #f6e6cb <?php else: ?> #efefef <?php endif; ?>;"
    role="presentation"
    >
    <tbody style="height: 117px;">
    <tr>
    ...
    <?php else: ?>
    <td align="center" style="padding: 0; margin: 0; padding-top: 10px; padding-left: 15px; padding-right: 15px; font-size: 0px;">
    <a target="_blank" href="https://viewstripo.email" style="-webkit-text-size-adjust: none; -ms-text-size-adjust: none; mso-line-height-rule: exactly; text-decoration: underline; color: #926b4a; font-size: 14px;">
    <img src="https://tlr.stripocdn.email/content/guids/CABINET_455a2507bd277c27cf7436f66c6b427c/images/85851620374838300.png" alt=""style="display: block; border: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic;" width="30"
    />
    </a>
    </td>
    <?php endif; ?>
    ...
    <td align="center" style="margin: 0; padding-left: 10px; padding-right: 10px; padding-top: 15px; padding-bottom: 20px;">
    <p style="margin: 0; -webkit-text-size-adjust: none; -ms-text-size-adjust: none; mso-line-height-rule: exactly; font-family: arial, 'helvetica neue', helvetica, sans-serif; line-height: 21px; color: #666666; font-size: 14px;">
    Giao Hàng Thành Công <?php if($order->status == 3): ?> <br /> <?php echo e($order->date_s); ?> <?php endif; ?>
    </p>
    </td>
    </tr>
    </tbody>
    ...
    align="center"
    ></p>
    <p style="mso-line-height-rule: exactly; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, 'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 13px 0;" align="center">
    <?php if($type != 4): ?> <?php echo e($subject); ?>, Chuẩn bị chiến thôi giáo sư! <?php else: ?> Thật đáng tiếc khi đơn hàng của quý khách đã bị huỷ :(( , Mong quý khách vẫn ủng hộ 2NITE SHOP <?php endif; ?>
    </p>
    <p style="mso-line-height-rule: exactly; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, 'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 13px 0;" align="center"><?php echo e($text); ?></p>
    </th>
    </tr>
    ...
    <span data-key="1468270_order_number">ID đơn hàng: </span><?php echo e($order->id); ?>
    ...
    Sản Phẩm Đã Đặt
     ...
     <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php $prd = App\Models\Products::where('id', '=' , $item->id)->first(); ?>
    ...
    width="140"
    class="product-image"
    src="<?php echo e($file->ver_img($item->options->image)); ?>"
    alt="Product Image"
    ...
    <a href="<?php echo e(route('detail_product', ['slug'=>$prd->slug])); ?>" target="_blank" style="color: #666363; text-decoration: none !important; text-underline: none; word-wrap: break-word; text-align: left !important; font-weight: bold;">
    <?php echo e($prd->name); ?>
    ...
    <?php echo e(App\Models\Insurance::where('id','=' ,$item->options->ins)->first()->group == 1 ? "Chế độ bảo hành:":"Phụ kiệm mua kèm"); ?> <?php echo e(App\Models\Insurance::where('id','=',$item->options->ins)->first()->name); ?>
    ...
    valign="middle"
    >
    <img width="40" style="width: 40px; vertical-align: middle; height: auto !important; font-weight: bold;" alt="Mastercard Icon" src="<?php echo e($file->ver_img('client/images/cod.png')); ?>" />
    </th>
    <th
    ...
    valign="middle"
    >
    <img width="40" style="width: 40px; vertical-align: middle; height: auto !important; font-weight: bold;" alt="Mastercard Icon" src="<?php echo e($file->ver_img('client/images/transfer.png')); ?>" />
    </th>
    <th
    style="mso-line-height-rule: exactly; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, 'Karla'; font-size: 16px; line-height: 26px; font-weight: bold; color: #666363; padding: 8px 0;"
    align="left"
    ...
    <?php if($order->note!= null): ?> <?php echo e($order->note); ?> <br />
    <?php endif; ?>
    <a href="mailto:" style="color: #ecba78; text-decoration: none !important; text-underline: none; word-wrap: break-word;" target="_blank"><?php echo e($order->email); ?></a>
    </p>
    </th>
    </tr>
    </tbody>
    ...
    <p style="mso-line-height-rule: exactly; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, 'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;" align="right">
    <?php echo e($order->prov); ?><br />
    <?php echo e($order->dist); ?><br />
    <?php echo e($order->ward); ?><br />
    ...
    Nếu khách hàng cần sự giúp đỡ hãy liên hệ với email: vaone6v2@gmail.com hoặc GỌI: <?php echo e(getVal('hotline')->value); ?> :)
    </p>
    </th>
    </tr>
    ...
    >
    <a
    href="https://vachill.com/pages/quy-dinh-chung"
    target="_blank"
    style="
    color: #bdbdbd;
    text-decoration: none !important;
    ...
    >
    <a
    href="https://vachill.com/contact"
    target="_blank"
    style="
    color: #bdbdbd;
    text-decoration: none !important;
    ...
    <a class="social-link" href="https://www.facebook.com/awang1601/" target="_blank" title="Facebook" style="color: #ecba78; text-decoration: none !important; text-underline: none; font-size: 14px; text-align: center;">
    ...
    <a class="social-link" href="https://twitter.com/diepvuonganh2" target="_blank" title="Twitter" style="color: #ecba78; text-decoration: none !important; text-underline: none; font-size: 14px; text-align: center;">
    ...
    <a class="social-link" href="https://www.instagram.com/diepvuonganh9/" target="_blank" title="Instagram" style="color: #ecba78; text-decoration: none !important; text-underline: none; font-size: 14px; text-align: center;">
    ...
    <a class="social-link" href="https://www.youtube.com/channel/UCftso1X6pEwNsiPBl7p1Tpw" target="_blank" title="YouTube" style="color: #ecba78; text-decoration: none !important; text-underline: none; font-size: 14px; text-align: center;">
    ...
    valign="top"
    >
    dAv1<br style="text-align: center;" />
    151/60 Trần Hoàng Na<br style="text-align: center;" />
    Cần Thơ<br style="text-align: center;" />
    ...
    bgcolor="#ffffff"
    >
    <a href="https://vachill.com" target="_blank" data-key="section_shop_block1" style="color: #ecba78; text-decoration: none !important; text-underline: none; font-size: 14px; font-weight: 400; text-transform: none;">vachill.com</a>
    </th>
    </tr>
    <!-- Store Website : END -->
    </tbody>
...
<?php /**PATH /home/u217861923/domains/vachill.com/public_html/resources/views/client/mail/order.blade.php ENDPATH**/ ?>