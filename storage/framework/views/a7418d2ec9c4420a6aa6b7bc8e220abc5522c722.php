            ...
            <div class="card">
                ...
                <div class="card-body" id="config__home--add">
                    ...
                    <div class="d-flex justify-content-end align-items-center mb-4">
                        <input type="checkbox" name="active" value="1" <?php if($config->active == 1): ?> checked <?php endif; ?> class="toggle-active" data-id=<?php echo e($config->id); ?> data-toggle="toggle"  data-width="100">
                    </div>
