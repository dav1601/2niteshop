...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group img d-none mb-5">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group html d-none mb-5">
                            <label for="">Value HTML</label>
                            <textarea name="value" id="value_config_infor" class="form-control my-editor"><?php echo old('value'); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group not-html d-none mb-5">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $config_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('delete_cofinfor_handle', ['id' => $conf->id])); ?>"
                                                class="d-block delete_conf" data-id="<?php echo e($conf->id); ?>">
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\2niteshop\home\u217861923\domains\vachill.com\public_html\resources\views/admin/dashboard/config_info.blade.php ENDPATH**/ ?>