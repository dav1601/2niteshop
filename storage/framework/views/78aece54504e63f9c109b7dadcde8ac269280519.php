<li class="pgb-package init-sort-package trans-025-all w-100" pack-id="<?php echo e($package['id']); ?>" data-type="package-item"
    ...
    <div class="w-100 d-flex justify-content-around align-items-center">
        <div class="pgb-package-name text-uppercase" style="width:200px">
            <?php echo e(config('pagebuilder.short_code.' . $package['payload']['type'])['name']); ?>

        </div>
        <div class="pbg-package-act d-flex justify-content-center align-items-center" style="150px">
