...
<?php $__env->startSection('import_js'); ?>
    ...
    <script src="<?php echo e(asset('admin/app/js/user.js')); ?>?ver=<?php echo filemtime('admin/app/js/user.js') ?>"></script>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <input type="hidden" name="" id="ajax__avatar--loading" value="<?php echo e(url('client/images/fire.svg')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group mb-5">
                                    ...
                                    <textarea class="form-control" name="biography" id="" placeholder="Giới thiệu điều gì đó về bản thân bạn"
                                        rows="5"><?php echo e($profile->biography); ?></textarea>
                                </div>
                            </div>
                            <div class="col-4 edit__pro5--right d-flex justify-content-center align-items-center ml-0 mr-0">
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="text" class="form-control" placeholder="1234 Main St"
                                            name="address_1" value="<?php echo e($profile->address_1); ?>" id=""
                                            placeholder="">
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="text" class="form-control" placeholder="Chung cư , studio......"
                                            name="address_2" value="<?php echo e($profile->address_2); ?>" id=""
                                            placeholder="">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <?php else: ?>
                                            <select class="custom-select" name="city" id="prov">
                                                <option value="<?php echo e($profile->city); ?>">
                                                    <?php echo e(App\Models\Province::where('id', '=', $profile->city)->first()->_name); ?>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" name="dist" id="dist">
                                            ...
                                            <?php else: ?>
                                                <option value="<?php echo e($profile->d); ?>">
                                                    <?php echo e(App\Models\District::where('id', '=', $profile->d)->first()->_name); ?>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" name="ward" id="ward">
                                            ...
                                            <?php else: ?>
                                                <option value="<?php echo e($profile->w); ?>">
                                                    <?php echo e(App\Models\Ward::where('id', '=', $profile->w)->first()->_name); ?>
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="text" class="form-control" name="facebook"
                                            value="<?php echo e($profile->facebook); ?>" id=""
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="text" class="form-control" name="instagram"
                                            value="<?php echo e($profile->instagram); ?>" id=""
                                            placeholder="Có thể để trống">
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="text" class="form-control" name="zalo"
                                            value="<?php echo e($profile->zalo); ?>" id="" placeholder="Có thể để trống">
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="text" class="form-control" name="twitter"
                                            value="<?php echo e($profile->twitter); ?>" id=""
                                            placeholder="Có thể để trống">
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="text" class="form-control" name="github"
                                            value="<?php echo e($profile->github); ?>" id="" placeholder="Có thể để trống">
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="text" class="form-control" name="linkedIn"
                                            value="<?php echo e($profile->linkedIn); ?>" id=""
                                            placeholder="Có thể để trống">
                                    </div>
                                </div>
...
<?php if($daviUser->ApiExists()): ?>
    <!-- Modal -->
    <div class="modal fade" id="getSecurityCode" tabindex="-1" aria-labelledby="getSecurityCodeLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="getApiToken" tabindex="-1" aria-labelledby="getApiTokenLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="background-color: #222e3c !important;">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" id="getApiTokenBtn" class="btn btn-primary">Lấy Token Và Truy Cập
                        Api</button>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\2niteshop\home\u217861923\domains\vachill.com\public_html\resources\views/admin/users/setting-profile.blade.php ENDPATH**/ ?>