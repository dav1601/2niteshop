    ...
    <div class="w-100  owl-carousel owl-theme mb-4">
        <div class="item">
            <a  class="d-block w-100">
                <img src="<?php echo e($file->ver_img('client/images/plc-1.png')); ?>" class="img-fluid" alt="<?php echo e($bt->name); ?>">
            </a>
        </div>
        <div class="item">
            <a  class="d-block w-100">
                <img src="<?php echo e($file->ver_img('client/images/plc-2.png')); ?>" class="img-fluid" alt="<?php echo e($bt->name); ?>">
            </a>
        </div>
        <div class="item">
            <a  class="d-block w-100">
                <img src="<?php echo e($file->ver_img('client/images/plc-3.png')); ?>" class="img-fluid" alt="<?php echo e($bt->name); ?>">
            </a>
        </div>
        <div class="item">
            <a  class="d-block w-100">
                <img src="<?php echo e($file->ver_img('client/images/plc-4.png')); ?>" class="img-fluid" alt="<?php echo e($bt->name); ?>">
            </a>
        </div>
    </div>
