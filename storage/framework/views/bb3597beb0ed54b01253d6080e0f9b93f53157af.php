            ...
            <div class="nav__content bd-grid">
                ...
                <div class="nav__menu">
                    <ul class="nav__list">
                        ...
                        <?php if(Gate::allows('admin-action')): ?>
                        <li class="nav__item"><a href="<?php echo e(route('minify')); ?>" target="_blank" class="nav__link">Minify</a></li>
                        <?php endif; ?>
                    </ul>
                </div>
...
<?php /**PATH /home/u217861923/domains/vachill.com/public_html/resources/views/components/admin/navbar.blade.php ENDPATH**/ ?>