...
<?php endif; ?>
                <li class="nite__menu--item">
                    <a href="tel:<?php echo e(str_replace(' ', '', getVal('switchboard')->value)); ?>"  >
                        <div class="icon-name">
                            <img src="<?php echo e($file->ver_img_local('client/images/phone-call.png')); ?>" width="25" height="25" alt="icon phone call">
                ...
                <li class="nite__menu--item">
                    <a href="https://suachua.haloshop.vn">
                        <div class="icon-name">
                            <img src="<?php echo e($file->ver_img_local('client/images/service.png')); ?>" width="25" height="25" alt="icon service">
