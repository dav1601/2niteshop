...
<head>
    ...
    <meta name='description' itemprop='description' content='<?php echo $__env->yieldContent(' meta-desc', config('2niteseo.meta.defaults.description')); ?>' />
...
<?php endif; ?>
    ...
    <input type="hidden" name="" id="cookie_view"
        value="<?php echo e(Cookie::has('view') ? Cookie::get('view') : ' grid'); ?>">
    <input type="hidden" name="" id="no-show-popup"
        value="<?php echo e(Session::has('nsp') ? Session::get('nsp') : 0); ?>">
